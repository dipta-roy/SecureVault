...
class StorageManager:
    ...
    def __init__(self, filepath: str):
        ...
        self._biometric_key_id = f"securevault_{self._get_vault_id()}"
    ...
    def enable_biometric(self, master_password: str) -> bool:
        """
        Enable biometric authentication for this vault.
    ...
    def disable_biometric(self) -> bool:
        """
        Disable biometric authentication for this vault.
    ...
    def has_biometric_data(self) -> bool:
        """Check if biometric data is stored for this vault."""
        if not self.biometric.is_available():
            return False
    ...
    def _save(self) -> None:
        ...
        self._set_file_permissions(self.filepath)
